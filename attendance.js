    ...
    students.forEach((student) => {  
        ...
        if (student.nganh == selectedNganh)
        {
            ...
            `<li id="${student.id.toString()}" class="list-unstyled col-sm-12 col-md-3 col-lg-3" style="margin:auto">
                <div class="card">
                    <img src="./placeholder.jpg" class="card-img-top" alt="..." style="max-height: 500px; margin-top:10px; padding-left:40px; padding-right:40px; overflow:hidden; border-radius:50%;">
                    <div class="card-body">
